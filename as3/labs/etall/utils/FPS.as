package labs.etall.utils
{
    ...
    public class FPS extends Sprite
    {
		...
		private function onDisposeHandler(e:Event):void 
		{
			removeEventListener(Event.REMOVED_FROM_STAGE, onDisposeHandler);
		...
		private function run(ev:Event):void{
            ...
            if (instance == null)
            {
				...
				this.addEventListener(Event.REMOVED_FROM_STAGE,onDisposeHandler);
        ...
        {
			var bmd:BitmapData = new BitmapData(70, 70, true, 0xff000000);
