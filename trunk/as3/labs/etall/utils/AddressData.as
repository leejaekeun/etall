package labs.etall.utils{
{
	...
	{
		static private const DATA:Object = { "110000":["\u5317\u4eac", "1"],
									  "110100":["\u5317\u4eac\u5e02", "110000"],
									  "110101":["\u4e1c\u57ce\u533a", "110100"],
									  "110102":["\u897f\u57ce\u533a", "110100"],
									  "110103":["\u5d07\u6587\u533a", "110100"],
		...
		static public function getProvince():Array {
			return getDataById("1");
		}
		
		static public function getCityByProvinceId(id:String):Array {
			return getDataById(id);
		}
		
		static public function getDistrictByCityId(id:String):Array {
			return getDataById(id);
		}
		
		static public function getDataById(id:String):Array {
			var returnData:Array = new Array();
			for (var i:String in DATA) {
				 if (DATA[i][1] == id) {
					returnData.push({data:i,label:DATA[i][0]});
				} 
			}
			returnData.sortOn("data",Array.NUMERIC);
			return returnData;
		}
	}
